...
<body>
    ...
    <ul class="placeul">
    <li><a href="#">首页</a></li>
    <li><a href="/q_options">q_options列表</a></li>
    <li><a href="#">修改q_options</a></li>
    </ul>
    </div>
    
    <div class="formbody">
    
    <div class="formtitle"><span>修改q_options</span></div>
    
    <form action="/q_options/update" method="post">
		<#include "_form.ftl" />
	</form>
