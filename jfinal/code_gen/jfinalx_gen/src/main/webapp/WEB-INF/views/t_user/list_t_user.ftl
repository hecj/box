	...
	<table class="list">
		<tbody>
			<tr>
				...
				<th width="10%">thirdID(第三方接入用户的id)</th>
			 
				<th width="12%">操作</th>
			</tr>
			
			<#list t_user_page.getList() as o>
			<tr>
					...
					<td style="text-align:left;">${(o.thirdID)!}</td>
				<td style="text-align:left;">
					&nbsp;&nbsp;<a href="/t_user/delete/${o.id}" onclick="return confirm('您正在执行删除操作，是否继续？')">删除</a>
					&nbsp;&nbsp;<a href="/t_user/edit/${o.id}">修改</a>
				</td>
			</tr>
			</#list>
		</tbody>
