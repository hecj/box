...
public abstract class Routes {
	...
	private final Map<String, Class<? extends JfinalxController>> map = new HashMap<String, Class<? extends JfinalxController>>();
	 ...
	 */
	public Routes add(String controllerKey, Class<? extends JfinalxController> controllerClass, String viewPath) {
	 ...
	 * @param controllerClass Controller Class
	 */
	public Routes add(String controllerkey, Class<? extends JfinalxController> controllerClass) {
		return add(controllerkey, controllerClass, controllerkey);
	}
	
	public Set<Entry<String, Class<? extends JfinalxController>>> getEntrySet() {
		return map.entrySet();
	}
