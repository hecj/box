...
<body>
    ...
    <table class="tablelist">
    	...
    	<th ><input name="" type="checkbox" onclick="checkAll(this.checked,'')"/></th>
			<th title="">id</th>
			<th title="角色名称">n</th>
			<th title="通用查询权限字符逗号分隔" style="width:300px;">qs</th>
			<th title="菜单权限id字符 逗号分开" style="width:300px;">ms</th>
        ...
        <tr>
			...
			<td style="text-align:center;"><span command_list="qs" >${r.qs!}</span> </td>
			<td style="text-align:center;"><span command_list="ms" >${r.ms!}</span></td>
