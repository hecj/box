<ul class="menuson" >
    ...
    <li><cite></cite><a href="/balanceUser" target="rightFrame">userBalance(用户余额管理)</a><i></i></li>
	<li><cite></cite><a href="/olu" target="rightFrame">UserLog(用户日志)</a><i></i></li>    
</ul> 
<style>
	.leftmenu li{
		display:none;
...
jQuery(function(){
	...
	if("${__u.username}"=="admin"){//如果是管理员 例外
