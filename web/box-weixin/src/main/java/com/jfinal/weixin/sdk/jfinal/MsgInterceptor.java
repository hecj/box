...
public class MsgInterceptor implements  Interceptor{
	...
	public void intercept(ActionInvocation inv) {
		...
		if (controller instanceof JfinalxController == false)
	 ...
	 * 检测签名
	 */
	private boolean checkSignature(JfinalxController controller) {
	 ...
	 * 是否为开发者中心保存服务器配置的请求
	 */
	private boolean isConfigServerRequest(JfinalxController controller) {
	 ...
	 */
	public void configServer(JfinalxController c) {
