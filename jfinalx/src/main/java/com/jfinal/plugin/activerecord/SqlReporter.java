...
import cn.peon.jfinal.core.SqlFormatUtil;
...
public class SqlReporter implements InvocationHandler {
	 ...
	 * 是否格式化sql
	 */
	private static boolean formartsql = false;
	public static boolean loggerOn = false;
	private static final Logger log = Logger.getLogger(SqlReporter.class);
	
	public static void setFormartsql(boolean formartsql) {
		SqlReporter.formartsql = formartsql;
	}
