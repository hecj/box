...
final class ActionReporter {
	 ...
	 */
	static final boolean reportCommonRequest(JfinalxController controller, Action action) {
	 ...
	 */
	static final void reportMultipartRequest(JfinalxController controller, Action action) {
		doReport(controller, action);
	}
	
	private static final void doReport(JfinalxController controller, Action action) {
		StringBuilder sb = new StringBuilder("\nJFinal action report -------- ").append(sdf.format(new Date())).append(" ------------------------------\n");
		Class<? extends JfinalxController> cc = action.getControllerClass();
