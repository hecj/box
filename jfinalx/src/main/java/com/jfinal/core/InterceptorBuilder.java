...
class InterceptorBuilder {
	 ...
	 */
	Interceptor[] buildControllerInterceptors(Class<? extends JfinalxController> controllerClass) {
	 ...
	 */
	Interceptor[] buildActionInterceptors(Interceptor[] defaultInters, Interceptor[] controllerInters, Class<? extends JfinalxController> controllerClass, Interceptor[] methodInters, Method method) {
	...
	private ClearLayer getControllerClearType(Class<? extends JfinalxController> controllerClass) {
