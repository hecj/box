...
final class ActionMapping {
	...
	private Set<String> buildExcludedMethodName() {
		...
		Method[] methods = JfinalxController.class.getMethods();
	...
	void buildActionMapping() {
		...
		for (Entry<String, Class<? extends JfinalxController>> entry : routes.getEntrySet()) {
			Class<? extends JfinalxController> controllerClass = entry.getValue();
	...
	private static final void warnning(String actionKey, Class<? extends JfinalxController> controllerClass, Method method) {
