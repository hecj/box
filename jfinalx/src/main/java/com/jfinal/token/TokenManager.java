...
public class TokenManager {
	...
	/**
	 * Create Token.
	 * @param JfinalxController
	 * @param tokenName token name
	 * @param secondsOfTimeOut seconds of time out, for ITokenCache only.
	 */
	public static void createToken(JfinalxController controller, String tokenName, int secondsOfTimeOut) {
		if (tokenCache == null) {
	 ...
	 */
	private static void createTokenHiddenField(JfinalxController controller, String tokenName, String tokenId) {
		StringBuilder sb = new StringBuilder();
		sb.append("<input type='hidden' name='").append(tokenName).append("' value='" + tokenId).append("' />");
		controller.setAttr("token", sb.toString());
	}
	
	private static void createTokenUseTokenIdGenerator(JfinalxController controller, String tokenName, int secondsOfTimeOut) {
	 ...
	 */
	public static synchronized boolean validateToken(JfinalxController controller, String tokenName) {
