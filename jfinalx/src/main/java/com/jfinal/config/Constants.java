...
final public class Constants {
	...
	private ControllerInstancer controllerInstancer=new ControllerInstancer() {
		@Override
		public JfinalxController instance(Action action) throws InstantiationException,
				IllegalAccessException {
			return action.getControllerClass().newInstance();
		}
	};
	
	
	public ControllerInstancer getControllerInstancer() {
		return controllerInstancer;
	}

	public void setControllerInstancer(ControllerInstancer controllerInstancer) {
		this.controllerInstancer = controllerInstancer;
	}
